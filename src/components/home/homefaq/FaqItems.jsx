    ...
    return(
        <div className="w-2/3 h-full flex justify-between items-center">
            <div className="w-full">
                <div onClick={()=>setOpenFaq(!openFaq)} className="cursor-pointer border-b border-gray-500 flex justify-between items-center gap-2 font-mainFont1 text-xl overflow-hidden py-2">
                    <div>{question}</div>
                    <div>
