...
const AwardAndHonour = ()=>{
    ...
    return(
        <div id="honoursandawards" className="py-0 lg:py-5">
                ...
                <div className="w-full lg:w-[70%] bg-white p-1 lg:p-5 rounded-xl border border-gray-200">
                    {
                        awardAndHonour.map(({
                            ...
                            return <div key={id} className="grid grid-cols-3 gap-3">
                                <p className="col-span-3 lg:col-span-2 contentText">{content1}</p>
                                <img className="col-span-3 lg:col-span-1 h-full object-cover rounded-xl" src={awardImg1} alt="" />
                                <img className="col-span-3 lg:col-span-2 h-full object-cover rounded-xl" src={awardImg2} alt="" />
                                <img className="col-span-3 lg:col-span-1 h-full object-cover rounded-xl" src={awardImg4} alt="" />
